...
#define u_isISOControle U_ICU_ENTRY_POINT_RENAME(u_isISOControle)
...
#define ubidi_isBidiControle U_ICU_ENTRY_POINT_RENAME(ubidi_isBidiControle)
#define ubidi_isInverse U_ICU_ENTRY_POINT_RENAME(ubidi_isInverse)
#define ubidi_isJoinControle U_ICU_ENTRY_POINT_RENAME(ubidi_isJoinControle)
