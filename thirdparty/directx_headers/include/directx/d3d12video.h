...
typedef struct D3D12_VIDEO_ENCODER_AV1_PICTURE_CONTROL_CODEC_DATA
    ...
    _Field_size_full_(QPMapValuesCount)  INT16 *pRateControleQPMap;
...
typedef struct D3D12_FEATURE_DATA_VIDEO_ENCODER_RATE_CONTROL_MODE
    ...
    UINT NodeIndex;
    D3D12_VIDEO_ENCODER_CODEC Codec;
    D3D12_VIDEO_ENCODER_RATE_CONTROL_MODE RateControleMode;
    BOOL IsSupported;
...
typedef struct D3D12_FEATURE_DATA_VIDEO_ENCODER_SUPPORT
    ...
    D3D12_VIDEO_ENCODER_RATE_CONTROL RateControle;
...
typedef struct D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264
    ...
    UINT QPMapValuesCount;
    _Field_size_full_(QPMapValuesCount)  INT8 *pRateControleQPMap;
...
typedef struct D3D12_VIDEO_ENCODER_PICTURE_CONTROL_DESC
    ...
    D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA PictureControleCodecData;
...
typedef struct D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS
    {
    D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_DESC SequenceControleDesc;
    D3D12_VIDEO_ENCODER_PICTURE_CONTROL_DESC PictureControleDesc;
